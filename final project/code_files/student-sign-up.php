...
<form action="student-registration.php" style="border:1px solid #ccc" method="post">
  <div class="container">
    ...
    <input type="text" placeholder="Enter your major subject initial" name="major" required>
